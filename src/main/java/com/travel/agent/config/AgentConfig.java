 ...
 * 智能体装配（核心）。
 *
 * <p>使用 AiServices 把 LLM、Tools、Memory 组装为面向接口的 TravelAgent。
 * 这是从"传统聊天机器人"跨向"自主智能体"的关键一步。
 *
 * <p>演进：
 * <ul>
 *   <li>M1：chatModel + memory（基础对话）</li>
 *   <li>M2：加入 tools（自主调用天气/航班/酒店）—— 当前阶段</li>
 *   <li>M3：加入 contentRetriever（知识检索，需配置有效 Embedding Key 后启用）</li>
 * </ul>
 */
@Configuration
