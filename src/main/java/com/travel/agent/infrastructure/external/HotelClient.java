 ...
 * 酒店服务客户端（一期 Mock 实现）。
 *
 * <p>调研结论：免费开放 API 中无酒店预订/搜索服务，真实接入需商业 API
 * （携程 / EAN，需 key + 审核），待后续提供。
...
public class HotelClient {
    ...
    public HotelBooking book(String city, String hotelName, String checkIn, String checkOut, String roomType) {
